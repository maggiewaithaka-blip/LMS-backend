# Generated by Django 4.2.26 on 2025-12-30 11:39
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('passport_photo', models.ImageField(blank=True, null=True, upload_to='profiles/passport_photos/')),
                ('national_id', models.FileField(blank=True, null=True, upload_to='profiles/national_ids/')),
                ('passport', models.FileField(blank=True, null=True, upload_to='profiles/passports/')),
                ('academic_certificate', models.FileField(blank=True, null=True, upload_to='profiles/certificates/')),
                ('email', models.EmailField(blank=True, max_length=255, null=True)),
                ('phone', models.CharField(blank=True, max_length=32, null=True)),
                ('date_of_birth', models.DateField(blank=True, null=True)),
                ('gender', models.CharField(blank=True, max_length=20, null=True)),
                ('address', models.TextField(blank=True, null=True)),
                ('qualification_level', models.CharField(blank=True, max_length=64, null=True)),
                ('field_of_study', models.CharField(blank=True, max_length=128, null=True)),
